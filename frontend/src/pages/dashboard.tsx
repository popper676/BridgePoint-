...
const Dashboard = () => {
  ...
  const [promotions, setPromotions] = React.useState('Loading...');
  const [purchases, setPurchases] = React.useState('Loading...');
  const [rooms, setRooms] = React.useState('Loading...');
  const [tickets, setTickets] = React.useState('Loading...');
  const [socialmediadata, setSocialmediadata] = React.useState('Loading...');
  const [revenue, setRevenue] = React.useState('Loading...');
      ...
      <SectionMain>
        ...
        >
          ...
          {hasPermission(currentUser, 'READ_PROMOTIONS') && (
            <Link href={'/promotions/promotions-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
          ...
          {hasPermission(currentUser, 'READ_PURCHASES') && (
            <Link href={'/purchases/purchases-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
          ...
          {hasPermission(currentUser, 'READ_ROOMS') && (
            <Link href={'/rooms/rooms-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
          ...
          {hasPermission(currentUser, 'READ_TICKETS') && (
            <Link href={'/tickets/tickets-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
          ...
          {hasPermission(currentUser, 'READ_SOCIALMEDIADATA') && (
            <Link href={'/socialmediadata/socialmediadata-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
          ...
          {hasPermission(currentUser, 'READ_REVENUE') && (
            <Link href={'/revenue/revenue-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
