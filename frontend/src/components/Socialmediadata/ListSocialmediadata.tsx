            ...
            >
              ...
              >
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/socialmediadata/socialmediadata-edit/?id=${item.id}`}
                  pathView={`/socialmediadata/socialmediadata-view/?id=${item.id}`}
                  hasUpdatePermission={hasUpdatePermission}
                />
              </div>
            </CardBox>
          ))}
        {!loading && socialmediadata.length === 0 && (
...
export default ListSocialmediadata;
