...
import { loadColumns } from './configureSocialmediadataCols';
...
const TableSampleSocialmediadata = ({
  filterItems,
  setFilterItems,
  filters,
  showGrid,
  ...
  const {
    ...
    loading,
    count,
    notify: socialmediadataNotify,
    refetch,
  } = useAppSelector((state) => state.socialmediadata);
  ...
  useEffect(() => {
    if (socialmediadataNotify.showNotification) {
      notify(
        socialmediadataNotify.typeNotification,
        socialmediadataNotify.textNotification,
      );
    }
  }, [socialmediadataNotify.showNotification]);
  ...
  const handleEditAction = (id: string) => {
    router.push(`/socialmediadata/${id}`);
  };

  const handleViewAction = (id: string) => {
    router.push(`/socialmediadata/socialmediadata-view/?id=${id}`);
  };
...
export default TableSampleSocialmediadata;
