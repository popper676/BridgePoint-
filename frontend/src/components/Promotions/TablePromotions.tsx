...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/promotions/promotionsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configurePromotionsCols';
...
const TableSamplePromotions = ({
  ...
  useEffect(() => {
    if (promotionsNotify.showNotification) {
      notify(
        promotionsNotify.typeNotification,
        promotionsNotify.textNotification,
      );
    }
  }, [promotionsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/promotions/promotions-view/?id=${id}`);
  };

  const handleCreateEventAction = ({ start, end }: SlotInfo) => {
    router.push(
      `/promotions/promotions-new?dateRangeStart=${start.toISOString()}&dateRangeEnd=${end.toISOString()}`,
    );
  };
    ...
    <>
      ...
      {!showGrid && (
        <BigCalendar
          ...
          pathEdit={`/promotions/promotions-edit/?id=`}
          pathView={`/promotions/promotions-view/?id=`}
...
export default TableSamplePromotions;
