...
const CardUsers = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_PROMOTIONS');
              ...
              >
                ...
                <div className='ml-auto '>
                  <ListActionsPopover
                    ...
                    onEdit={onEdit}
                    itemId={item.id}
                    pathEdit={`/promotions/promotions-edit/?id=${item.id}`}
                    pathView={`/promotions/promotions-view/?id=${item.id}`}
