...
const CardUsers = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_PURCHASES');
            ...
            >
              ...
              >
                ...
                <div className='ml-auto '>
                  <ListActionsPopover
                    ...
                    onEdit={onEdit}
                    itemId={item.id}
                    pathEdit={`/purchases/purchases-edit/?id=${item.id}`}
                    pathView={`/purchases/purchases-view/?id=${item.id}`}
              ...
              <dl className='divide-y  divide-stone-300   dark:divide-dark-700 px-6 py-4 text-sm leading-6 h-64 overflow-y-auto'>
                ...
                <div className='flex justify-between gap-x-4 py-3'>
                  ...
                  <dd className='flex items-start gap-x-2'>
                    <div className='font-medium line-clamp-4'>
                      {dataFormatter.ticketsOneListFormatter(item.ticket)}
                    </div>
                  </dd>
                </div>
                ...
                <div className='flex justify-between gap-x-4 py-3'>
                  ...
                  <dd className='flex items-start gap-x-2'>
                    <div className='font-medium line-clamp-4'>
                      {dataFormatter.dateTimeFormatter(item.purchase_date)}
                    </div>
                  </dd>
                </div>
