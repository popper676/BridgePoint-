...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/purchases/purchasesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configurePurchasesCols';
...
const TableSamplePurchases = ({
  ...
  useEffect(() => {
    if (purchasesNotify.showNotification) {
      notify(
        purchasesNotify.typeNotification,
        purchasesNotify.textNotification,
      );
    }
  }, [purchasesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/purchases/purchases-view/?id=${id}`);
  };
...
export default TableSamplePurchases;
