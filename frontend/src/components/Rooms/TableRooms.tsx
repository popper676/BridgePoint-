...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/rooms/roomsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureRoomsCols';
...
const TableSampleRooms = ({
  ...
  useEffect(() => {
    if (roomsNotify.showNotification) {
      notify(roomsNotify.typeNotification, roomsNotify.textNotification);
    }
  }, [roomsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/rooms/rooms-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {rooms && Array.isArray(rooms) && !showGrid && (
        <CardRooms
          rooms={rooms}
          loading={loading}
...
export default TableSampleRooms;
