...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/revenue/revenueSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureRevenueCols';
...
const TableSampleRevenue = ({
  ...
  useEffect(() => {
    if (revenueNotify.showNotification) {
      notify(revenueNotify.typeNotification, revenueNotify.textNotification);
    }
  }, [revenueNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/revenue/revenue-view/?id=${id}`);
  };
...
export default TableSampleRevenue;
