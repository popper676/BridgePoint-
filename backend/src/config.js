...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: 'cc7ed12b734b57f928203dcc78b40d1b',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'BridgePoint  <app@flatlogic.app>',
  ...
  project_uuid: '8a91c21d-8bea-4036-8c1b-ae7747cc297e',
  flHost:
...
config.pexelsQuery = 'calm scenic landscape';
config.host =
