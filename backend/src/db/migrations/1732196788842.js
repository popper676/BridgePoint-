module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    const transaction = await queryInterface.sequelize.transaction();
    try {
      await queryInterface.removeColumn('revenue', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('socialmediadata', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('tickets', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('rooms', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('purchases', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('promotions', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('feedback', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('bookings', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('tickets', 'price', { transaction });
      ...
      await queryInterface.removeColumn('purchases', 'redeemed', {
        transaction,
      });

      await queryInterface.removeColumn('purchases', 'purchase_date', {
        transaction,
      });

      await queryInterface.removeColumn('purchases', 'ticketId', {
        transaction,
      });

      await queryInterface.removeColumn('purchases', 'userId', { transaction });

      await queryInterface.removeColumn('promotions', 'end_date', {
        transaction,
      });

      await queryInterface.removeColumn('promotions', 'start_date', {
        transaction,
      });

      await queryInterface.removeColumn('promotions', 'details', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('feedback', 'userId', { transaction });

      await queryInterface.removeColumn('bookings', 'confirmed', {
        transaction,
      });

      await queryInterface.removeColumn('bookings', 'check_out', {
        transaction,
      });

      await queryInterface.removeColumn('bookings', 'check_in', {
        transaction,
      });

      await queryInterface.removeColumn('bookings', 'roomId', { transaction });
      ...
      await queryInterface.dropTable('revenue', { transaction });

      await queryInterface.dropTable('socialmediadata', { transaction });
